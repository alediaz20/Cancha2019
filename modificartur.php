  ...
  <div id="cabecera">
   ...
   <div id="ventana">
    ...
    <form method="POST" action="programa.php?accion=modificartur&id_tur=<?php echo "$id_tur";?>">
       ...
       Cliente
       <div class="form-group">
        <input type="text" name="nom_cli" value="<?php echo $tur['nom_cli'],' ',$tur['ape_cli']?>" class="form-control" autofocus readonly>
       </div>
      <!-- 
       </div>
       Apellido
       <div class="form-group">
        <input type="text" name="ape_cli" value="<?php echo $tur['ape_cli']?>" class="form-control" autofocus readonly>
       </div>
-->
      <div class="form-group"> 
